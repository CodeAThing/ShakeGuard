/*
  ...
  1. New Tables
    - `earthquake_reports`
      ...
      - `intensity` (double precision, not null, 1-10 scale)
  ...
  3. Performance
    - Add indexes for timestamp, coordinates, and intensity queries
    - Sample data for testing

  4. Changes
    - Removed problematic index with now() function to fix IMMUTABLE error
